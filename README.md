...
|---|---|---|
| haiku | Механика/read-only | Поиск файлов, чтение конфигов, grep, короткие вопросы — не код |
...
Правила выбора: по умолчанию — sonnet, если не уверен; haiku — только для чтения/поиска/простых вопросов, не для кода; opus — только когда нужен глубокий анализ или планирование; Explore-агент всегда на haiku (он для быстрого поиска); Plan-агент предпочтительно на opus (качество планирования критично для последующих фаз).

...
- [claude-stack](https://github.com/zarudesu/claude-stack) — эта репа
- [adhdrenaline-site](https://github.com/zarudesu/adhdrenaline-site) — сайт-хаб контентного проекта (Hugo, GitHub Pages)
- [focus-room](https://github.com/zarudesu/focus-room) — веб-компаньон для фокус-сессий
- [subs4what](https://github.com/zarudesu/subs4what) — мобильное приложение учёта подписок
- [poker_train_flop](https://github.com/zarudesu/poker_train_flop) — покерный тренажёр по флопам
